...
public class PurchaseDaoHibernate extends GenericDaoHibernate<Purchase, Long>
	...
	public List<Purchase> findPurchasesByUser(Long userId, int startIndex,
		...
		return getSession()
				...
				.setParameter("userId", userId).setMaxResults(count)
				.setFirstResult(startIndex).list();
	}

	public int getNumberOfPurchases(Long userProfileId) {
		long numberOfPurchases = (Long) getSession()
				.createQuery(
