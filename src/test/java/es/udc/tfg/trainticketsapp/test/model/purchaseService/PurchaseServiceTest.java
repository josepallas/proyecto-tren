...
public class PurchaseServiceTest {
	...
	private final String USER_EMAIL="jose@gmail.com";
	...
	@Test
	public void buyTicketsTest() throws InstanceNotFoundException {
		initialiceDatabase();
		UserProfile userProfile=new UserProfile(USER_LOGIN, USER_PASSWORD,FIRST_NAME, LAST_NAME, USER_EMAIL, USER_DNI,
				USER_BIRTHDATE, TYPE_USER);
	...
	@Test
	public void cancelTicketTest() throws InstanceNotFoundException, TimeoutTicketException{
		initialiceDatabase();
		UserProfile userProfile=new UserProfile(USER_LOGIN, USER_PASSWORD,FIRST_NAME, LAST_NAME, USER_EMAIL, USER_DNI,
				USER_BIRTHDATE, TYPE_USER);
		userProfileDao.save(userProfile);
	...
	public void cancelTimeoutTicketTest() throws InstanceNotFoundException, TimeoutTicketException{
		initialiceDatabase();
		UserProfile userProfile=new UserProfile(USER_LOGIN, USER_PASSWORD,FIRST_NAME, LAST_NAME, USER_EMAIL, USER_DNI,
				USER_BIRTHDATE, TYPE_USER);
		userProfileDao.save(userProfile);
